...
test.describe('SSO External - Keycloak Integration @regression @integration', () => {
  ...
  test('@smoke should login to Keycloak and check op and nc client are present', async ({ page }) => {
