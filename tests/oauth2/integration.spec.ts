...
test.describe('OAuth2 Integration @regression @integration', () => {
  ...
  test('@smoke should login to OpenProject', async ({ page }) => {
  ...
  test('@smoke should login to Nextcloud', async ({ page }) => {
    const loginPage = new NextcloudLoginPage(page);
