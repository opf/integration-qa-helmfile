...
When this skill triggers, read `.agents/shared/playwright-cli/SKILL.md` before using `playwright-cli`. This adapter stays at `.claude/skills/playwright-cli/SKILL.md` so Claude can auto-discover it.
