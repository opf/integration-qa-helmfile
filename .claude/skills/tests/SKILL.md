...
When this skill triggers, read `.agents/shared/openproject-e2e.md` before writing or reviewing E2E tests. This adapter stays at `.claude/skills/tests/SKILL.md` so Claude can auto-discover it.
